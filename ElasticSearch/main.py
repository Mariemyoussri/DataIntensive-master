...
def elastic_search_worker():
    while True :
        ...
        folder_path = os.environ['parquet_path']
            ...
            if os.path.isdir(os.path.join(folder_path, folder)):
                ...
                for sub_folder in os.listdir(os.path.join(folder_path, folder)):
                    for file in os.listdir(os.path.join(folder_path, folder, sub_folder)):
                        ...
                        if os.path.getsize(file) != 0 and file_extension==".parquet":
                            print('File:', file)
...
while not connected:
    # Try to ping the Elasticsearch instance
    if es.ping():
        connected = True
        print("Connected to Elasticsearch.")
    else:
        print("Failed to connect to Elasticsearch. Retrying in 5 seconds...")
        time.sleep(5)

# Define Elasticsearch index name and document type
index_name = 'weather_stations_data'
doc_type = 'parquet'
